    ...
    <div className="relative">
        <main className='text-neutral-300 bg-neutral-950 px-4 min-h-screen'>
            <section className='max-w-6xl mx-auto py-10 mono z-20 relative'>
                ...
                <p className='pt-10 text-2xl'>I provide designs and applications that are dependable and accessible. I'm always learning and staying up to date with the newest technologies. You can be sure that your business will be in the right hands.</p>
                </div>
            </section>
